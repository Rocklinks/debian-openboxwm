...
packages=(
    ...
    bc openbox obconf playerctl xcompmgr parcellite htop neofetch i3lock
...
sudo chmod 777 "$config_dir/polybar/*"
sudo chmod 777 "$config_dir/polybar/rofi/*"
sudo chmod 777 "$config_dir/polybar/scripts/*"
